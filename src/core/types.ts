...
export type WorkerRequest = { type: 'load'; id: number; name: string; bytes: ArrayBuffer } | { type: 'generate' | 'export' | 'maximize'; id: number; settings: BrimSettings; enabled: string[]; format?: SlicerFormat } | { type: 'cancel'; id: number };

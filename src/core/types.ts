...
export interface BrimResult { objects: ObjectBrim[]; regions: { outside: number; holes: number; pockets: number }; bounds: Bounds; warnings: string[]; settings: BrimSettings; computeMs: number }
